...
% --- Dark palette ------------------------------------------------------
\definecolor{bgdark}{RGB}{22,24,29}
\definecolor{fgtext}{RGB}{229,231,235}
\definecolor{accent}{RGB}{96,165,250}   % blue-400, structure/links/bullets
\definecolor{muted}{RGB}{156,163,175}   % footline / secondary text
\definecolor{lobeN}{RGB}{59,130,246}    % MFS icon: N-domain lobe
\definecolor{lobeC}{RGB}{249,115,22}    % MFS icon: C-domain lobe
\definecolor{substrate}{RGB}{236,72,153} % MFS icon: bound-substrate dot
...
\setbeamertemplate{itemize/enumerate body begin}{\setlength{\itemsep}{40em}}
    ...
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        \item Key phytohormone in plants; isolated in 1931 from
          ...
          (1950)
        \item Promotes growth and development: stem elongation, seed
          germination, flowering
        \item GA-deficiency mutants (key oxidase disrupted): smaller but
          more resilient, \textbf{higher grain yield}
...
\begin{frame}{Nitrate and Peptide Transporters (NPF)}
  \begin{itemize}
    \item Part of the \textbf{Major Facilitator Superfamily (MFS)} of
      membrane transporters
    \item Transport nitrate (NO\textsubscript{3}\textsuperscript{-}),
      dipeptides, and gibberellins
    \item Tissue- and substrate-specific
  \end{itemize}
  % TODO: figure -- NPF tissue localization diagram (Morales de los Rios et al., 2025)
  % \includegraphics[width=0.5\textwidth]{npf_tissue_localization.png}
\end{frame}
    ...
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        \item Only \textbf{2 NPFs} have experimentally resolved
          structures: NPF6.3 (4OH3, 5A2N, 5A2O), NPF2.10 (9UI1, 9UI6,
          9UIF, 9UIT)
